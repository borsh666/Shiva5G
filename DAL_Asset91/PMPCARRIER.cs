...
namespace DAL
{
    ...
    public partial class PMPCARRIER
    {
        ...
        public PMPCARRIER()
        {
            this.CARRIERAMCTHRESHOLD = new HashSet<CARRIERAMCTHRESHOLD>();
            this.CARRIERFEED = new HashSet<CARRIERFEED>();
        }
        ...
        public virtual ICollection<CARRIERAMCTHRESHOLD> CARRIERAMCTHRESHOLD { get; set; }
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<CARRIERFEED> CARRIERFEED { get; set; }

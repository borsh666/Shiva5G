...
namespace DAL
{
    ...
    public partial class PMPSECTOR
    {
        ...
        public PMPSECTOR()
        {
            this.PMPCARRIER = new HashSet<PMPCARRIER>();
            this.SECTORANTENNA = new HashSet<SECTORANTENNA>();
        }
        ...
        public virtual ICollection<PMPCARRIER> PMPCARRIER { get; set; }
        public virtual PMPHUB PMPHUB { get; set; }
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<SECTORANTENNA> SECTORANTENNA { get; set; }
    }
}

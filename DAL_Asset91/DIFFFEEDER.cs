...
namespace DAL
{
    ...
    public partial class DIFFFEEDER
    {
        public decimal PROJECTNO { get; set; }
        public Nullable<decimal> DPROJECTNO { get; set; }
        public decimal FEEDERKEY { get; set; }
        public decimal DFEEDERKEY { get; set; }
        public string IDNAME { get; set; }
        public string DIDNAME { get; set; }
        public Nullable<decimal> FREQ { get; set; }
        public Nullable<decimal> DFREQ { get; set; }
        public Nullable<decimal> LOSSPERMETRE { get; set; }
        public Nullable<decimal> DLOSSPERMETRE { get; set; }
        public Nullable<decimal> CONNLOSS { get; set; }
        public Nullable<decimal> DCONNLOSS { get; set; }
